#
# Module manifest for module 'AzureResourceSecurity'
#
...
@{
    ...
    FunctionsToExport = @('Get-AzureRegion', 'Assert-SecureResourceGroupPolicyLocation', 'Assert-SecureResourceGroupRbac', 'Assert-SecureSubscriptionPolicyLocation')
    ...
    PrivateData = @{
        ...
        PSData = @{
            ...
            ProjectUri = 'https://github.com/jamesbannan/azure-automation-resource-security/blob'
